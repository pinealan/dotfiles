...
let s:dimgrey= s:colors.dimgrey
...
call s:h("ColorColumn", { "fg": s:transparent, "bg": s:black }) " used for the columns set with 'colorcolumn'
...
call s:h("Normal", { "fg": s:white, "bg": s:dimgrey }) " normal text
...
call s:h("Visual", { "fg": s:transparent, "bg": s:visual_grey }) " Visual mode selection
