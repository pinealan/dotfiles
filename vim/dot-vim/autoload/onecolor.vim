...
function! onecolor#set_all(colors)
    ...
    call onecolor#set("Cursor",          { "gui": "reverse" })
    call onecolor#set("CursorIM",        { "bg": a:colors.fg_normal })
    ...
    call onecolor#set("FoldColumn",      { "fg": a:colors.fg_quiet })
    ...
    call onecolor#set("NormalFloat",     { "bg": a:colors.bg_max })
    "call onecolor#set("FloatBorder",     { "bg": a:colors.bg_status, "fg": a:colors.fg_max, })
    "call onecolor#set("FloatTitle",      {})
    "call onecolor#set("FloatFooter",     {})

    call onecolor#set("Pmenu",           { "bg": a:colors.bg_visual })
    call onecolor#set("PmenuSel",        { "bg": a:colors.blue, "fg": s:black })
    "call onecolor#set("PmenuKind",       {})
    "call onecolor#set("PmenuKindSel",    {})
    "call onecolor#set("PmenuExtra",      {})
    "call onecolor#set("PmenuExtraSel",   {})
    call onecolor#set("PmenuSbar",       { "bg": a:colors.fg_normal })
    call onecolor#set("PmenuThumb",      { "bg": a:colors.fg_quiet })

    call onecolor#set("Question",        { "fg": a:colors.purple })
    call onecolor#set("QuickFixLine",    { "bg": a:colors.bg_max })
    ...
    call onecolor#set("StatusLineNC",    { "fg": a:colors.fg_quiet, "bg": a:colors.bg_max })
