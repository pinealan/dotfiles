...
require('which-key').add({
    ...
    { '<leader>tc', desc = 'String/comment color' },
    { '<leader>tb', desc = 'Bold comments' },
    { '<leader>tt', desc = 'treesitter context' },
    { '<leader>td', desc = 'lSP Diagnostics' },
    { '<leader>tg', desc = 'git gutter' },
    { '<leader>ti', desc = 'illuminate' },
    { '<leader>tj', desc = 'fast escape (jj)' },
    { '<leader>tm', desc = 'Mark sign column' },
    { '<leader>tp', desc = 'paste mode' },
    { '<leader>tr', desc = 'rainbow parens' },
    { '<leader>ts', desc = 'spell check' },
    { '<leader>tw', desc = 'soft wrap' },
