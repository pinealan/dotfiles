...
vim.keymap.set('n', '<leader>fg', function() t.git_commits({ "git", "log", "--pretty=format:%h %as %s", "--abbrev-commit", "--", "." }) end)
vim.keymap.set('n', '<leader>fh', function() t.git_bcommits({ "git", "log", "--pretty=format:%h %as %s", "--abbrev-commit", "--follow" }) end)
